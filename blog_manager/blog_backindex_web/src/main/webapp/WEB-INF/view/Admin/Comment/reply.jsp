...
<rapid:override name="content">
    ...
    <form class="layui-form"  method="post" id="myForm" action="/admin/comment/replySubmit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="commentAuthorName"  value="${sessionScope.loginUser.getUserNickname()}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">我的邮箱 </label>
            <div class="layui-input-block">
                <input type="text" name="commentAuthorEmail"  value="${sessionScope.loginUser.getUserEmail()}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">我的网址 </label>
            <div class="layui-input-block">
                <input type="text" name="commentAuthorUrl"  value="${sessionScope.loginUser.getUserUrl()}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
